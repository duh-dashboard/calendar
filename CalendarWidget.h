...
class CalendarWidget : public QObject, public dashboard::IWidget {
    Q_OBJECT
    Q_INTERFACES(dashboard::IWidget)
    Q_PLUGIN_METADATA(IID IWidget_iid FILE "calendar.json")

public:
    explicit CalendarWidget(QObject* parent = nullptr);
